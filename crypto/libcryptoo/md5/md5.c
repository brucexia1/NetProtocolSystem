...
#define DATA_ORDER_IS_LITTLE_ENDIAN   //md5 use LITTLE_ENDIAN
...
static inline void
MD5_Transform(MD5_CTX *c, const unsigned char *p, uint32_t num)
{
    const unsigned char *data = p;
    register uint32_t A, B, C, D, l;
    uint32_t XX[MD5_LBLOCK];
    #define X(i)   XX[i]
