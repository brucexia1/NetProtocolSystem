...
static inline void
SHA256_Transform(SHA256_CTX *ctx, const unsigned char *in, uint32_t num)
{
...
int SHA256_Update(SHA256_CTX *c, const void *_data, uint32_t len)
{
